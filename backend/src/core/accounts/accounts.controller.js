...
export async function listGroups(req, res, next) {
  try {
    const groups = await accountsService.listGroups();
...
export async function getGroup(req, res, next) {
  try {
    const group = await accountsService.getGroup(req.params.id);
...
export async function createGroup(req, res, next) {
  try {
    ...
    const group = await accountsService.createGroup({ name, nature, parentId });
...
export async function updateGroup(req, res, next) {
  try {
    ...
    const group = await accountsService.updateGroup(req.params.id, { name, parentId });
...
export async function deleteGroup(req, res, next) {
  try {
    const result = await accountsService.deleteGroup(req.params.id);
...
export async function listLedgers(req, res, next) {
  try {
    const ledgers = await accountsService.listLedgers({ groupId: req.query.groupId });
...
export async function getLedger(req, res, next) {
  try {
    const ledger = await accountsService.getLedger(req.params.id);
...
export async function createLedger(req, res, next) {
  try {
    ...
    const ledger = await accountsService.createLedger({ name, groupId, openingBalance, openingBalanceType });
...
export async function updateLedger(req, res, next) {
  try {
    const { name, groupId, openingBalance, openingBalanceType } = req.body;
    const ledger = await accountsService.updateLedger(req.params.id, { name, groupId, openingBalance, openingBalanceType });
...
export async function deleteLedger(req, res, next) {
  try {
    const result = await accountsService.deleteLedger(req.params.id);
